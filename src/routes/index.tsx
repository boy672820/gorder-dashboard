...
// Dashboard
const Waiting = Loadable(lazy(() => import('../pages/order/waiting/Index')));
const Processing = Loadable(lazy(() => import('../pages/order/processing/Index')));
const Completed = Loadable(lazy(() => import('../pages/order/completed/Index')));
